...
export const UpdateUserModal = ({ isModalActive, setIsModalActive }) => {
  ...
  return (
    <BaseModal isOpen={isModalActive} width="410px" isResponsiveModal={true}>
      <section className="flex flex-col items-center justify-center w-full p-4 gap-1">
            ...
            <section>
              ...
              {imagePreview ? (
                <section className="relative">
                  <img
                    className="w-40 h-40 sm:w-50 sm:h-50 rounded-full border-2 object-contain relative"
                    src={imagePreview}
                    alt="foto de perfil"
                  />
                  <p
                ...
                <section className="cursor-pointer relative">
                  ...
                  <label
                    htmlFor="file"
                    className="flex cursor-pointer items-center justify-center w-10 h-10 bottom-0 right-6 bg-blue-600 hover:bg-blue-700 text-white font-semibold transition text-2xl rounded-full absolute"
                  >
